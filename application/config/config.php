...
$is_local = (preg_match("#localhost#", $_SERVER['HTTP_HOST'])) ? true : false;
if($is_local){	
	
	$config['base_url'] = "storyville";
	define("BASE", "storyville/");
	$port = ($_SERVER['SERVER_PORT'] != 80) ? ":".$_SERVER['SERVER_PORT'] : "";
	define("SITE", "http://localhost".$port."/storyville");
	define("SITE_TITLE", "Storyville");	
	define("ROOT", $_SERVER['DOCUMENT_ROOT']."/storyville");
...
/*
	Include classes here, as CodeIgniter kind of sucks
*/
require_once(LIB."/Common/Common.php");
Common::Package(LIB."/Common");
